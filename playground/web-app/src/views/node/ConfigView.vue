...
const envVars = [
  ...
  { name: 'OTEL_PROFILE', type: 'string', default: 'minimal', description: 'Profile ativo: minimal | standard | verbose', envVar: 'OTEL_PROFILE' },
  { name: 'OTEL_CAPTURE_BODY', type: 'boolean', description: 'Override: captura request body no span', envVar: 'OTEL_CAPTURE_BODY' },
  { name: 'OTEL_CAPTURE_RESPONSE', type: 'boolean', description: 'Override: captura response body no span', envVar: 'OTEL_CAPTURE_RESPONSE' },
  { name: 'OTEL_LOG_REQUEST_BODY', type: 'boolean', description: 'Override: inclui request body nos logs Pino' },
  { name: 'OTEL_LOG_RESPONSE_BODY', type: 'boolean', description: 'Override: inclui response body nos logs Pino' },
  { name: 'OTEL_LOG_BODY_IGNORE_ROUTES', type: 'string (CSV)', description: 'Regex de rotas onde body NÃO é logado' },
  { name: 'OTEL_LOG_BODY_ONLY_ROUTES', type: 'string (CSV)', description: 'Whitelist: body é logado APENAS nestas rotas' },
  { name: 'OTEL_SAMPLE_RATIO', type: 'number (0-1)', description: 'Override do sample ratio do profile' },
  { name: 'OTEL_IGNORE_URLS', type: 'string (CSV)', description: 'Paths HTTP ignorados pelo SDK (complementa profile)' },
  { name: 'OTEL_IGNORE_ROUTES', type: 'string (CSV)', description: 'Rotas ignoradas pelo interceptor/middleware' },
